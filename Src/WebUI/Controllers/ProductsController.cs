...
public class ProductsController : BaseController
{
    ...
    {
        ProductsListVm vm = await Mediator.Send(new GetProductsListQuery());
    ...
    {
        ProductDetailVm vm = await Mediator.Send(new GetProductDetailQuery { Id = id });
    ...
    {
        ProductsFileVm vm = await Mediator.Send(new GetProductsFileQuery());
